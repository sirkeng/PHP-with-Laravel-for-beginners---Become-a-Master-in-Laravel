...
Route::get('/insert', function(){
	...
	DB::insert('insert into posts(title, content) values(?, ?)', ['Laravel is awesome with Edwin', 'Laravel is the best thinng that has happened to PHP, PERIOD']);
...
// 	Post::create(['title'=>'the create method 1', 'content'=>'WOW I\'am learning alot with Edwin Diza 1']);
...
//Acesing the intermediate table/pivot
